...
\begin{abstract}
This paper studies the link between transformation synthesis and explaining outliers in relational data.  We present Arachnida where a user specifies an objective function  that scores records in terms of how anomalous they seem and the distributed system searches for an interpretable cleaning program (sequence of transformations) that maximally removes anomalies. This program provides an explanation of the anomalies in the sense that it is a minimal sequence of transformations that explains why those records have a high detection score. Arachnida adaptively learns a search heuristic with a logistic regression classifier to discover systematic patterns and is efficiently parallelizable. We compare Arachnida to several special-purpose systems on synthetic and real benchmarks  and find that Arachnida achieves similar accuracy and runtimes using the unified and general framework.
\end{abstract}
